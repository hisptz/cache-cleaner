...
/* Controllers */
var cacheCleanerControllers = angular
  .module('cacheCleanerControllers', [])
  ...
  .controller('MainController', function(
    ...
    $scope.selectAll = function() {
      ...
      angular.forEach($scope.ssKeys, function(ssKey) {
        ssKey.remove = shouldSelectAll;
      });

      angular.forEach($scope.lsKeys, function(lsKey) {
        lsKey.remove = shouldSelectAll;
      });

      angular.forEach($scope.dbKeys, function(dbKey) {
        dbKey.remove = shouldSelectAll;
      });
    };

    $scope.redirectToDataEntry = function() {
      $window.location.href = '../Ards-Data-entry/index.html';
    };
  });
