                ...
                if (htmlCode) {
                    ...
                    for (var i = 0; i < inputFields.length; i++) {
                        ...
                        if (attributes.hasOwnProperty('id')) {
                            ...
                            newInputField = newInputField + ' <span ng-messages="outerForm.' + fieldId + '.$error" class="required" ng-if="interacted(outerForm.' + fieldId + ')" ng-messages-include="library/angular-forms/error-messages.html"></span>';
            ...
            getForTrackedEntity: function (trackedEntityForm, target) {
                ...
                if (htmlCode) {
                    ...
                    for (var i = 0; i < inputFields.length; i++) {
                        ...
                        newInputField = newInputField + ' <span ng-messages="outerForm.' + fieldName + '.$error" class="required" ng-if="interacted(outerForm.' + fieldName + ')" ng-messages-include="library/angular-forms/error-messages.html"></span>';
